...
public class ReceitaBD {
    ...
    public List<Receita> consultaBairro() {
        List<Receita> listaBairro = new ArrayList<Receita>();
        Receita bairro;
        try {
    ...
    public List<Receita> consultaBairro (String nome) {
        List<Receita> listaBairro = new ArrayList<Receita>();
        Receita bairro;
        try {
            con = acessoBD.conectar();
    ...
    public boolean incluiBairro(Receita bairro) {
        try {
            con = acessoBD.conectar();
    ...
    public boolean alteraBairro(Receita bairro) {
        try {
            con = acessoBD.conectar();
     ...
     public boolean excluiBairro(Receita bairro) {
        try {
            con = acessoBD.conectar();
