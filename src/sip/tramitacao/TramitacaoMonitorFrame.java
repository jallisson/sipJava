...
import sip.util.MyTimer;
import static sip.util.MyTimer.TEMPO;

/**
 *
 * @author T2Ti
 */
public final class TramitacaoMonitorFrame extends javax.swing.JInternalFrame {
    ...
    private void defineModelo() {
        ...
        try {
            ...
            Logger.getLogger(TramitacaoMonitorFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
...
private void incluirTramitacao() throws ParseException {
    ...
    private void initComponents() {
        ...
        jLabel1.setBackground(new java.awt.Color(122, 149, 222));
        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sip/imagemsip/monitor_64x64_2.png"))); // NOI18N
        jLabel1.setText("Monitor de Movimento de Processos");
        jPanel1.add(jLabel1);
        ...
        cbTipoDoc.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "DESPACHO ", "ENCAMINHAMENTO", "LAUDO ", "MEMORANDO", "NOTIFICAÇÃO", "OFÍCIO", "PARECER CONCLUSIVO", "PARECER JURIDICO", "PARECER TÉCNICO", "REQUERIMENTO", "REQUISIÇÃO", "SOLICITAÇÃO", "TABELA", "TERMO" }));
        cbTipoDoc.setEnabled(false);
        ...
        jLabel10.setText("Processo Arquivado");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        ...
        jLabel11.setText("Processo em Observação");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        ...
        jLabel13.setText("Processo Desarquivado");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        ...
        jLabel15.setText("Liença Emitida");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
