 ...
 * @author Alessandra
 */
public class ColorirTabelaDenunciaApp extends DefaultTableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
     super.getTableCellRendererComponent(table, value, isSelected, hasFocus, row, column);
       //203,216,227
        ...
        if (text != null && "Novo".equals(text.toString())){
            // RGB
             c = Color.RED;
           
        }
         if(text != null && "Protocolado".equals(text.toString())){
              c = new Color(255,136 ,136);
        }
        if(text != null && "Enviado Fiscal".equals(text.toString())){
            c = Color.YELLOW;
        }
